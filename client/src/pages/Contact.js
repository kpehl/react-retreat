...
import { Button, CardTitle, CardImg, CardBody, CardSubtitle, CardText, CardDeck, Row, Col, Card, Container } from 'reactstrap';

const Contact = (props) => {
    return (
            <Row>
                <Card className="card-contact px-2 py-2 Col">
                    {/* <div className="card-contact px-2 py-2 Col"> */}
